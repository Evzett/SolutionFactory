# Прототип, разработанный в рамках хакатона

Это командный проект, выполненный на хакатоне. Я выступала лидом команды, курировала разработку концепта и архитектуру, а также помогала формировать продуктовую стратегию.

Основная идея прототипа — дать селлерам маркетплейсов инструмент для анализа продаж, выявления целевой аудитории и генерации персонального интернет-магазина из данных Wildberries и Ozon. Проект решает важную проблему: маркетплейсы сильно забирают комиссию, поэтому селлеры нуждаются в способе сохранить контроль над своими товарами, улучшить карточки и создать собственную витрину.
